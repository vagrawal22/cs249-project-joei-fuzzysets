...
# path_prefix = 'transe'
args.method = 'fuzzyset'
args.bridge = 'CMP-linear'
...
if args.method not in ['transe','distmult','hole','fuzzyset']:
...
kgf1 = "./data/dbpedia/db_insnet_train.txt"
kgf2 = "./data/dbpedia/db_onto_small_mini.txt"
alignf = "./data/dbpedia/db_InsType_mini.txt"

# kgf1 = "./data/yago/yago_insnet_train.txt" #ins train part
# kgf2 = "./data/yago/yago_ontonet.txt" #onto train part
# alignf = "./data/yago/yago_InsType_mini.txt" # all types
...
m_train.train(epochs=10, save_every_epoch=1, lr=0.0005, a1=args.a1, a2=args.a2, m1=args.m1, m2=args.m2, AM_fold=args.fold)

    # # Call save_embeddings for KG1 and KG2
    # KG1.save_embeddings(sess, 'fuzzy_embed1.pkl')
    # KG2.save_embeddings(sess, 'fuzzy_embed2.pkl')
