...
class Trainer(object):
    ...
    def build(self, multiG, method='fuzzyset', bridge='CG-one',  dim1=300, dim2=50, batch_sizeK1=1024, batch_sizeK2=1024, 
    ...
    def train1epoch_AM(self, sess, num_AM_batch, a1, a2, lr, epoch):
        ...
        for batch_id in range(num_AM_batch):
            ...
            _, loss_AM = sess.run([self.tf_parts._train_op_A, self.tf_parts._A_loss],  # Change _AM_loss to _A_loss
                    feed_dict={self.tf_parts._A_h_index: e1_index, 
                            self.tf_parts._A_r_index: e2_index,
                            self.tf_parts._A_t_index: e1_nindex,
                            self.tf_parts._A_hn_index: e2_nindex, 
                            self.tf_parts._A_tn_index: e1_nindex,
    ...
    def train(self, epochs=20, save_every_epoch=10, lr=0.001, a1=0.1, a2=0.05, m1=0.5, m2=1.0, AM_fold=1, half_loss_per_epoch=-1):
        ...
        save_path = 'fuzzy_embeddings.txt'
        self.tf_parts.save_embeddings(self.sess, save_path)
